...
train_dir = 'cifar-10-batches-py/data_batch_'
valid_dir = 'cifar-10-batches-py/test_batch'
...
def prepare_train_data(data_dir):
    ...
    for i in range(1, NUM_TRAIN_BATCH + 1):
        path_list.append(os.path.join(data_dir, train_dir+str(i)))
...
def read_validation_data(data_dir):
    ...
    '''
    validation_array, validation_labels = read_in_all_images([os.path.join(data_dir, valid_dir)],
